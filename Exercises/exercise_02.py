...
def protein_wight(protein):
    ...
    for amino in protein:
        totalWeight = totalWeight + AMINO_ACID_WEIGHTS[amino]
    return totalWeight



print(first_elements([0,1,2,3], 2))
print(first_element([0,1,2,3], 2))
print(n_elements([0, 1, 2, 3, 4, 5],2,3))
print(count_letters("navya"))
print(protein_wight("ACD"))
